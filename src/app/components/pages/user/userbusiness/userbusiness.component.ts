...
export class DirectorinfoComponent implements OnInit {
  ...
  public requiredFieldsOthrLng: string = "??? ?????? ??????";
  ...
  public arabicNumbers: any = [
    { baseNumber: '0', arabicNumber: '?' },
    { baseNumber: '1', arabicNumber: '?' },
    { baseNumber: '2', arabicNumber: '?' },
    { baseNumber: '3', arabicNumber: '?' },
    { baseNumber: '4', arabicNumber: '?' },
    { baseNumber: '5', arabicNumber: '?' },
    { baseNumber: '6', arabicNumber: '?' },
    { baseNumber: '7', arabicNumber: '?' },
    { baseNumber: '8', arabicNumber: '?' },
    { baseNumber: '9', arabicNumber: '?' }
  ]
