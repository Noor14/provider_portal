          ...
          slab: [
            {
              ...
              minPrice:
                this.selectedCurrency.CurrencyCode + " " + this.minPrice,
              slabName: "Normal"
            },
            {
              ...
              minPrice:
                this.selectedCurrency.CurrencyCode + " " + this.normalPrice,
              slabName: "+45"
            },
            {
